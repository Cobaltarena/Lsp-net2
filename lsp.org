...
#+LATEX_HEADER: \usepackage[margin=1.5in]{geometry} \captionsetup{labelformat=empty,labelsep=none}
...
There was a very annoying problem for companies promoting new languages and the communities built around them.
